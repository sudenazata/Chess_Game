...
namespace ChessLogic
{
    public class Board
    {
        private readonly Piece[,] piece = new Piece[8, 8];
        ...
        private void AddStartPiece()
        {
            ...
            this[0, 6] = new Knight(Player.Black); // DÜZELTİLDİ: King yerine Knight
            ...
            this[7, 6] = new Knight(Player.White); // DÜZELTİLDİ: King yerine Knight
