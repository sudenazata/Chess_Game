...
namespace ChessLogic
{
    public class StateString
    {
        ...
        private void AddCastlingRights(Board board)
        {
            ...
            bool castleBQS = board.CastleRightQS(Player.White);
        ...
        private void AddEnPassant(Board board, Player currrentPlayer)
        {
            if (!board.CanCaptureEnPassant(currrentPlayer))
            {
                sb.Append('-');
                return;
            }

            Position pos = board.GetPawnSkipPosition(currrentPlayer.Opponent());
